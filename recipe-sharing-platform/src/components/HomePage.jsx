  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-center text-gray-800">Recipe Sharing Platform</h1>
        <Link
          to="/add"
          className="mt-4 sm:mt-0 inline-block px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors font-semibold"
        >
          Add New Recipe
        </Link>
      </div>
